...
Added walking, jumping, single-block stepping, flight, block removal and placement, nine creative materials, desktop/touch controls, Quest tracked controllers, teleporting, smooth/snap turning, and a wrist palette. Added local autosave, export/import, protected invalid saves, and a versioned generation contract.
...
- Browser and deployment results will be recorded after the first workflow run.
...
- Saves are local to the current browser and origin. Export/import is the supported way to move them between phone, desktop, and headset.
